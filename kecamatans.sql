...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 20, 2021 at 04:24 PM
...
CREATE TABLE `kecamatans` (
  ...
  `kebupaten_id` char(4) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `kecamatans` (`id`, `kebupaten_id`, `nama_kecamatan`) VALUES
...
ALTER TABLE `kecamatans`
  ADD PRIMARY KEY (`id`),
  ADD KEY `kecamatans_kebupaten_id_foreign` (`kebupaten_id`);
...
--
ALTER TABLE `kecamatans`
  ADD CONSTRAINT `kecamatans_kebupaten_id_foreign` FOREIGN KEY (`kebupaten_id`) REFERENCES `kabupatens` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
